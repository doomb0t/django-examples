...
#test
STRIPE_PUBLISHABLE_KEY = 'pk_test_9CHCSOUrCqPBxAISFy5uHyiO'
STRIPE_SECRET_KEY = 'sk_test_OR84ceXF7iyB3xAM1FGgkp7j' 

#live
#STRIPE_PUBLISHABLE_KEY = 'sk_live_9ZQqxmVDxioNdRxQlK8tIWxr'
#STRIPE_SECRET_KEY = 'pk_live_Pmj9TBRTaI1iLwBRtz0F26S8'
